...
export const OrganizationRequestsPage: React.FC = () => {
  ...
  const currentDataLength = requests.length;
            ...
            {totalPages > 1 && (
              <div className="px-6 py-4 border-t border-[#E8EDF2] flex items-center justify-between bg-[#FBFBFC]">
                <p className="text-xs text-[#8A9AA8] font-medium">
                  ...
                  to{" "}
                  <span className="text-[#1A2A3A]">
                    {Math.min(currentPage * itemsPerPage, currentDataLength)}
                  </span>{" "}
                  of <span className="text-[#1A2A3A]">{currentDataLength}</span>{" "}
                  requests
                </p>
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="cursor-pointer px-3 py-1.5 rounded-md text-[11px] font-bold transition-colors disabled:opacity-40 disabled:cursor-not-allowed border border-[#E8EDF2] bg-white text-[#6B7A88] hover:bg-[#F8F9FB]"
                  >
                    Previous
                  </button>
                  <div className="flex items-center gap-1">
                    {Array.from({ length: totalPages }).map((_, i) => (
                      <button
                        ...
                        className={`cursor-pointer w-7 h-7 rounded-md text-[11px] font-bold transition-colors ${
                          currentPage === i + 1
